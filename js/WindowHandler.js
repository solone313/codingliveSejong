...
class WindowHandler {
    ...
    init() { // creates main window
        ...
        this._mainWindow2 = new BrowserWindow({
            show: false,
            icon: `${__dirname}/../images/favicon.png`
        });
        
        this._mainWindow2.maximize();

        // this._mainWindow.webContents.openDevTools();

        // and load the index.html of the app.
        this._mainWindow2.loadURL(`file://${__dirname}/../views/start.html`);

        // Emitted when the window is closed.
        this._mainWindow2.on('closed', () => {
            // Dereference the window object, usually you would store windows
            // in an array if your app supports multi windows, this is the time
            // when you should delete the corresponding element.
            this._mainWindow2 = null;
        ...
        this._mainWindow2.once('ready-to-show', () => {
            this._mainWindow2.show();
        })
